...
export const defaultSettings: SiteSettings = {
  ...
  footerAddress: "서울특별시 · 정확한 주소는 관리자 모드에서 입력해 주세요.",
  footerContact: "대표전화와 이메일을 관리자 모드에서 입력해 주세요.",
  footerCopyright: "Copyright © Northeast Asia Community ICT Forum. All rights reserved.",
  menus: [
